...
model BufferStorage
  ...
  parameter Modelica.Units.SI.MassFlowRate mHC1_flow_nominal(min=0) if
                                                                      useHeatingCoil1
    "Nominal mass flow rate of fluid 1 ports" annotation (Dialog(
      tab="Heating Coils and Rod",
      group="Nominal condition",
      enable=useHeatingCoil1));
  parameter Modelica.Units.SI.MassFlowRate mHC2_flow_nominal(min=0) if
                                                                      useHeatingCoil2
    "Nominal mass flow rate of fluid 1 ports" annotation (Dialog(
      tab="Heating Coils and Rod",
      group="Nominal condition",
...
////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer hConHC1=100
  ...
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer hConHC2=100
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  parameter Modelica.Units.SI.MassFlowRate m_flow_small_HC1=1E-4*abs(
      mHC1_flow_nominal) if                                                 useHeatingCoil1
    "Small mass flow rate for regularization of zero flow"
    annotation (Dialog(tab="Advanced", enable=useHeatingCoil1));
  parameter Modelica.Units.SI.MassFlowRate m_flow_small_HC2=1E-4*abs(
      mHC2_flow_nominal) if                                                 useHeatingCoil2
    "Small mass flow rate for regularization of zero flow"
    annotation (Dialog(tab="Advanced", enable=useHeatingCoil2));
...
////////////////////////////////////////////////////////////////////////////////////////////////////
for i in 2:(n-1) loop
    if nLowerPortDemand == i then
       connect(layer[i].ports[4], fluidportBottom2);
       if nUpperPortDemand == i then
         connect(layer[i].ports[6],fluidportTop2);
       end if;
    elseif nUpperPortDemand ==i then
   ...
   connect(layer[i].ports[2],layer[i+1].ports[1]);
    ...
    for i in 2:(n-1) loop
    if nLowerPortSupply == i then
       connect(layer[i].ports[3], fluidportBottom1);
       if nUpperPortSupply == i then
         connect(layer[i].ports[5],fluidportTop1);
       end if;
    elseif nUpperPortSupply ==i then
