...
model IndirectTankHeatExchanger
  ...
  AixLib.Fluid.MixingVolumes.MixingVolume vol[nSeg](
...
protected
  ...
  AixLib.Fluid.HeatExchangers.BaseClasses.HACoilInside hAPipIns[nSeg](
    each m_flow_nominal=m_flow_nominal,
  ...
  AixLib.Fluid.HeatExchangers.BaseClasses.HANaturalCylinder hANatCyl[nSeg](
