...
expandable connector PumpBus "Standard data bus with pump information"
  ...
  Modelica.Units.NonSI.AngularVelocity_rpm rpmMea "Pump speed actor signal"
    annotation (HideResult=false);
  Modelica.Units.SI.Power PelMea "Electrical pump power"
    annotation (HideResult=false);
  Modelica.Units.SI.Height dpMea
    "Pump pressure difference or head in meter water column"
    annotation (HideResult=false);
  Modelica.Units.SI.Efficiency efficiencyMea "Pump efficiency"
    annotation (HideResult=false);
  Modelica.Units.SI.Height dpSet "Pump head in meter water column";
  Modelica.Units.SI.MassFlowRate mFlowSet
