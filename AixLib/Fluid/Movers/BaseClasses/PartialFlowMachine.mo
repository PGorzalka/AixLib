...
partial model PartialFlowMachine
  ...
  parameter AixLib.Fluid.Types.InputType inputType = AixLib.Fluid.Types.InputType.Continuous
    "Control input type"
    annotation(Dialog(
      group="Control"));
...
protected
  ...
  AixLib.Fluid.Movers.BaseClasses.IdealSource preSou(
    redeclare final package Medium = Medium,
    final m_flow_small=m_flow_small,
    final allowFlowReversal=allowFlowReversal,
    final control_m_flow= (preVar ==  AixLib.Fluid.Movers.BaseClasses.Types.PrescribedVariable.FlowRate))
    "Pressure source"
...
"*** Warning: You are using a flow or pressure controlled mover with the
  ...
  assert(nominalValuesDefineDefaultPressureCurve or
         (per.havePressureCurve or
           (preVar == AixLib.Fluid.Movers.BaseClasses.Types.PrescribedVariable.Speed)) or
...
<a href=\"modelica://AixLib.Fluid.Movers.Examples.MoverContinuous\">
AixLib.Fluid.Movers.Examples.MoverContinuous</a>.
</li>
<li>
