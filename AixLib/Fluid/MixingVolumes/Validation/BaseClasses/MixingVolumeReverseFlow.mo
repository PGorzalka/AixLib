within AixLib.Fluid.MixingVolumes.Validation.BaseClasses;
partial model MixingVolumeReverseFlow
 ...
 package Medium = AixLib.Media.Air "Medium model";
  ...
  Sources.Boundary_pT bou(
    ...
    annotation (
      Placement(transformation(
        ...
        rotation=180,
        origin={70,-20})));
  replaceable AixLib.Fluid.MixingVolumes.MixingVolume volDyn
    constrainedby AixLib.Fluid.MixingVolumes.MixingVolume(
        redeclare package Medium = Medium,
        V=1,
        nPorts=2,
  ...
  replaceable AixLib.Fluid.MixingVolumes.MixingVolume volSte
    constrainedby AixLib.Fluid.MixingVolumes.MixingVolume(
        redeclare package Medium = Medium,
