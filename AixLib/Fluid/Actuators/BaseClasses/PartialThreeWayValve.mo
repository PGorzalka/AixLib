  ...
  extends AixLib.Fluid.BaseClasses.PartialThreeWayResistance(
    ...
    final mDyn_flow_nominal = m_flow_nominal,
      ...
      AixLib.Fluid.Actuators.BaseClasses.PartialTwoWayValve res1
        constrainedby AixLib.Fluid.Actuators.BaseClasses.PartialTwoWayValve(
          deltaM=deltaM,
          dp(start=dpValve_nominal/2),
          from_dp=from_dp,
          final linearized=linearized[1],
          final homotopyInitialization=homotopyInitialization,
          final CvData=AixLib.Fluid.Types.CvTypes.OpPoint,
      ...
      redeclare replaceable
      AixLib.Fluid.Actuators.BaseClasses.PartialTwoWayValve res3
        constrainedby AixLib.Fluid.Actuators.BaseClasses.PartialTwoWayValve(
          deltaM=deltaM,
          dp(start=dpValve_nominal/2),
          from_dp=from_dp,
