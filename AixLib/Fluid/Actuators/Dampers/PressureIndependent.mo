...
protected
  ...
  parameter Real[sizeSupSpl] kSupSpl_raw = AixLib.Fluid.Actuators.BaseClasses.exponentialDamper(
...
algorithm
  ...
  y := AixLib.Utilities.Math.Functions.smoothLimit(
    AixLib.Utilities.Math.Functions.cubicHermiteLinearExtrapolation(
      x=kTheta,
      x1=kSupSpl[i - 1],
      x2=kSupSpl[i],
      y1=ySupSpl[i - 1],
...
equation
  ...
  dp_min = AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
              m_flow=m_flow_set,
              k=kTotMax,
  ...
  if from_dp then
    ...
    m_flow_y1 = AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
    ...
    m_flow_smooth = noEvent(smooth(2,
        ...
        elseif dp_x >=dp_x2
        then m_flow_y2
        else AixLib.Utilities.Math.Functions.quinticHermite(
                 x=dp_x,
                 x1=dp_x1,
                 x2=dp_x2,
                 y1=m_flow_y1,
                 y2=m_flow_y2,
                 y1d= AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der(
                                     dp=dp_min + dp_x1,
                                     k=kTotMax,
                                     m_flow_turbulent=m_flow_turbulent,
                                     dp_der=1),
                 y2d=coeff1,
                 y1dd=AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der2(
                                     dp=dp_min + dp_x1,
                                     k=kTotMax,
                                     m_flow_turbulent=m_flow_turbulent,
                                     dp_der=1,
    ...
    dp_y1 = AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
    ...
    dp_smooth = noEvent(smooth(2,
        ...
        then dp_y2
                 ...
                 y1=dp_y1,
                 y2=dp_y2,
                 y1d=AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow_der(
                                     m_flow=m_flow_set + m_flow_x1,
                                     k=kTotMax,
                                     m_flow_turbulent=m_flow_turbulent,
                                     m_flow_der=1),
                 y2d=coeff2,
                 y1dd=AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow_der2(
                                     m_flow=m_flow_set + m_flow_x1,
                                     k=kTotMax,
                                     m_flow_turbulent=m_flow_turbulent,
                                     m_flow_der=1,
  ...
  y_actual_smooth = AixLib.Utilities.Math.Functions.regStep(
    x=y_internal - y_min,
