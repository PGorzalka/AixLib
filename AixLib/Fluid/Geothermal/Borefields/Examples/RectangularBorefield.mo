within AixLib.Fluid.Geothermal.Borefields.Examples;
model RectangularBorefield "Example model of a rectangular borefield"
  ...
  final parameter AixLib.Fluid.Geothermal.Borefields.Data.Filling.Bentonite filDat
    annotation (Placement(transformation(extent={{20,40},{40,60}})));
  final parameter AixLib.Fluid.Geothermal.Borefields.Data.Soil.SandStone soiDat
    "Soil data" annotation (Placement(transformation(extent={{50,40},{70,60}})));
  final parameter AixLib.Fluid.Geothermal.Borefields.Data.Configuration.Template conDat(
    final borCon=AixLib.Fluid.Geothermal.Borefields.Types.BoreholeConfiguration.SingleUTube,
    final use_Rb=false,
  ...
  AixLib.Fluid.Geothermal.Borefields.OneUTube borFie(
