...
model Borefields
  ...
  AixLib.Fluid.Geothermal.Borefields.TwoUTubes borFie2UTubSer(
    redeclare package Medium = Medium,
  ...
  AixLib.Fluid.Sources.MassFlowSource_T sou2(
    ...
    T=303.15) "Source" annotation (Placement(transformation(extent={{-92,50},{
            -72,70}},
                  rotation=0)));
  AixLib.Fluid.Sensors.TemperatureTwoPort T2UTubSerIn(
    redeclare package Medium = Medium,
  ...
  AixLib.Fluid.Sources.Boundary_pT sin2(
    ...
    T=283.15) "Sink" annotation (Placement(transformation(extent={{90,50},{70,
            70}}, rotation=0)));
  AixLib.Fluid.Sensors.TemperatureTwoPort T2UTubSerOut(
    redeclare package Medium = Medium,
    m_flow_nominal=borFie2UTubSerDat.conDat.mBorFie_flow_nominal,
    tau=0)
  ...
  AixLib.Fluid.Geothermal.Borefields.OneUTube borFieUTub(
    redeclare package Medium = Medium,
  ...
  AixLib.Fluid.Sources.MassFlowSource_T sou(
    ...
    T=303.15) "Source" annotation (Placement(transformation(extent={{-92,-70},{
            -72,-50}}, rotation=0)));
  AixLib.Fluid.Sensors.TemperatureTwoPort TUTubIn(
    redeclare package Medium = Medium,
  ...
  AixLib.Fluid.Sources.Boundary_pT sin(
    ...
    T=283.15) "Sink" annotation (Placement(transformation(extent={{90,-70},{70,
            -50}}, rotation=0)));
  AixLib.Fluid.Sensors.TemperatureTwoPort TUTubOut(
    redeclare package Medium = Medium,
    m_flow_nominal=borFieUTubDat.conDat.mBorFie_flow_nominal,
    tau=0)
    "Inlet temperature of the borefield with UTube configuration"
