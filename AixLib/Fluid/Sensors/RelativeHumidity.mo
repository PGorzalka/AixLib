...
equation
  ...
  phi = AixLib.Utilities.Psychrometrics.Functions.phi_pTX(
    p=port.p,
    T=T,
    X_w=Xi[1]);
...
<a href=\"modelica://AixLib.Fluid.Sensors.RelativeHumidityTwoPort\">AixLib.Fluid.Sensors.RelativeHumidityTwoPort</a>
