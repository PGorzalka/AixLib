...
model Basic "Example implementation of flow system"
  ...
  AixLib.Fluid.Movers.FlowControlled_dp pmpSouth(
    ...
    redeclare replaceable
      AixLib.Fluid.Movers.Data.Pumps.Wilo.Stratos80slash1to12 per,
    dp_nominal=12*9810,
    ...
    "Pump to south of building" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-60,-20})));
  AixLib.Fluid.FixedResistances.PressureDrop pipSouth1(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-80,18})));
  AixLib.Fluid.FixedResistances.PressureDrop pipSouth2(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    m_flow_nominal=3) "Pipe 2 to south of building" annotation (Placement(
        ...
        rotation=90,
        origin={-40,18})));
  AixLib.Fluid.Movers.FlowControlled_dp pmpNorth(
    redeclare package Medium = Medium,
    redeclare replaceable
      AixLib.Fluid.Movers.Data.Pumps.Wilo.Stratos80slash1to12 per,
    dp_nominal=12*9810,
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
     "Pump to north of building" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={60,-20})));
  AixLib.Fluid.FixedResistances.PressureDrop pipNorth2(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    m_flow_nominal=5) "Pipe 2 to north of building" annotation (Placement(
        ...
        rotation=90,
        origin={80,18})));
  AixLib.Fluid.FixedResistances.PressureDrop pipNorth1(
    redeclare package Medium = Medium,
    dp_nominal=50000,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={40,18})));
  AixLib.Fluid.Actuators.Valves.TwoWayLinear[4] valSouth1(
    each dpFixed_nominal=0,
    each CvData=AixLib.Fluid.Types.CvTypes.OpPoint,
    ...
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-80,60})));
  AixLib.Fluid.Actuators.Valves.TwoWayLinear[8] valSouth2(
    each dpFixed_nominal=0,
    each CvData=AixLib.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
    ...
    annotation (Placement(transformation(extent={{10,10},{-10,-10}},
        rotation=270,
        origin={-40,60})));
  AixLib.Fluid.Actuators.Valves.TwoWayLinear[4] valNorth1(
    each dpFixed_nominal=0,
    each CvData=AixLib.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
    ...
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={40,60})));
  AixLib.Fluid.Actuators.Valves.TwoWayLinear[8] valNorth2(
    each dpFixed_nominal=0,
    each CvData=AixLib.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
  ...
  AixLib.Fluid.Actuators.Valves.ThreeWayLinear valSouth(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-60,-50})));
  AixLib.Fluid.Actuators.Valves.ThreeWayLinear valNorth(
    redeclare package Medium = Medium,
    m_flow_nominal=5,
    dpFixed_nominal={20000,0},
    from_dp=true,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={60,-50})));
  AixLib.Fluid.HeatExchangers.PrescribedOutlet heater(
    m_flow_nominal=10,
    dp_nominal=100,
    redeclare package Medium = Medium,
    use_X_wSet=false)                  "Heating device"
    annotation (Placement(transformation(extent={{-70,-110},{-50,-90}})));
  AixLib.Fluid.Sources.Boundary_pT bou(nPorts=1,
  ...
  AixLib.Fluid.FixedResistances.Junction spl1(
    m_flow_nominal={10,10,10},
    dp_nominal={10,10,10},
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
  ...
  AixLib.Fluid.Movers.FlowControlled_m_flow pumpHea(
    m_flow_nominal=10,
  ...
  AixLib.Fluid.Actuators.Valves.TwoWayLinear valHea(
    dpFixed_nominal=0,
  ...
  AixLib.Fluid.Actuators.Valves.TwoWayLinear valCoo(
    dpFixed_nominal=0,
    CvData=AixLib.Fluid.Types.CvTypes.OpPoint,
    redeclare package Medium = Medium,
    m_flow_nominal=10,
  ...
  AixLib.Fluid.FixedResistances.Junction spl2(
    m_flow_nominal={10,10,10},
    dp_nominal={1000,10,10},
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Splitter"
    annotation (Placement(transformation(extent={{40,-110},{20,-90}})));
  AixLib.Fluid.FixedResistances.Junction spl3(
    m_flow_nominal={10,10,10},
    dp_nominal={10,10,10},
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Splitter"
    annotation (Placement(transformation(extent={{20,-120},{40,-140}})));
  AixLib.Fluid.Movers.FlowControlled_m_flow pumpCoo(
    m_flow_nominal=10,
    redeclare AixLib.Fluid.Movers.Data.Pumps.Wilo.VeroLine80slash115dash2comma2slash2 per,
    redeclare package Medium = Medium,
    inputType=AixLib.Fluid.Types.InputType.Stages,
  ...
  AixLib.Fluid.FixedResistances.PressureDrop tabsSouth1[4](
    redeclare each package Medium = Medium,
    ...
    "Pressure drop of southern tabs sections on collector 1" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-80,90})));
  AixLib.Fluid.FixedResistances.PressureDrop tabsSouth2[8](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
    ...
    "Pressure drop of southern tabs sections on collector 2" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-40,90})));
  AixLib.Fluid.FixedResistances.PressureDrop tabsNorth1[4](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
    ...
    "Pressure drop of northern tabs sections on collector 1" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={40,90})));
  AixLib.Fluid.FixedResistances.PressureDrop tabsNorth2[8](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
