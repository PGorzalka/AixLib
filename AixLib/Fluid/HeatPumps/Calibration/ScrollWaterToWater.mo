within AixLib.Fluid.HeatPumps.Calibration;
model ScrollWaterToWater
  "Calibration model for scroll water to water heat pump"
  extends Modelica.Icons.Example;
  extends AixLib.Fluid.HeatPumps.Calibration.BaseClasses.PartialWaterToWater(
    redeclare package Medium1 = AixLib.Media.Water,
    redeclare package Medium2 = AixLib.Media.Water,
    redeclare AixLib.Fluid.HeatPumps.ScrollWaterToWater heaPum(
      datHeaPum(
        etaEle=etaEle,
        PLos=PLos,
        dTSup=dTSup,
    ...
    calDat(tableName="ManufacturerData",
          ...
          "modelica://AixLib/Resources/src/fluid/heatpumps/calibration/manufacturerData.txt")),
    UACon = 12000.0,
    UAEva = 12000.0,
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-140,-100},
    ...
    preferredView="info",
    __Dymola_Commands(file= "modelica://AixLib/Resources/Scripts/Dymola/Fluid/HeatPumps/Calibration/ScrollWaterToWater.mos"
        "Simulate and plot"),
