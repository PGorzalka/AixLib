...
model SimpleRoomFourElementsTraceSubstance
  ...
  extends AixLib.ThermalZones.ReducedOrder.Examples.SimpleRoomFourElements(thermalZoneFourElements(
  ...
  AixLib.Fluid.Sources.MassFlowSource_T souAir(
    redeclare package Medium = Medium,
    use_C_in=true,
    ...
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-30,-70})));
  AixLib.Fluid.Sources.Boundary_pT sinAir(
    redeclare package Medium = Medium,
    C={400},
