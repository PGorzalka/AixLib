...
model OneAppartment_VoWo
  ...
  Utilities.Interfaces.RadPort
                            StarLivingroom annotation(Placement(transformation(extent = {{-40, 12}, {-24, 28}}), iconTransformation(extent = {{-40, 0}, {-24, 14}})));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a ThermChildren annotation(Placement(transformation(extent={{34,28},
            ...
            {50,44}})));
  Utilities.Interfaces.RadPort
                            StarChildren annotation(Placement(transformation(extent = {{60, 24}, {76, 40}}), iconTransformation(extent = {{56, 22}, {76, 42}})));
  ...
  Utilities.Interfaces.RadPort
                            StarBedroom annotation(Placement(transformation(extent = {{-40, -20}, {-24, -4}}), iconTransformation(extent = {{-40, -20}, {-24, -2}})));
  ...
  Utilities.Interfaces.RadPort
                            StarBath annotation(Placement(transformation(extent = {{0, -28}, {16, -12}}), iconTransformation(extent = {{-2, -28}, {16, -12}})));
  ...
  Utilities.Interfaces.RadPort
                            StarKitchen annotation(Placement(transformation(extent = {{62, -22}, {78, -6}}), iconTransformation(extent = {{34, -44}, {52, -26}})));
equation
  ...
  connect(Livingroom.WindSpeedPort, WindSpeedPort) annotation(Line(points={{-64.9412,58.9333},{-80,58.9333},{-80,90},{-41,90},{-41,113}},            color = {0, 0, 127}));
  ...
  connect(Livingroom.thermOutside, thermOutside) annotation(Line(points={{-64.9412,74.5333},{-80,74.5333},{-80,110},{-72,110}},          color = {191, 0, 0}));
  ...
  connect(Livingroom.thermNeighbour, thermNeighbour_Livingroom) annotation(Line(points={{-64.9412,53.7333},{-80,53.7333},{-80,90},{-110,90}},          color = {191, 0, 0}));
  ...
  connect(Livingroom.thermBedroom, Bedroom.thermLivingroom) annotation(Line(points={{-64.9412,48.5333},{-80,48.5333},{-80,-47.6},{-64,-47.6}},          color = {191, 0, 0}));
  connect(Corridor.thermLivingroom, Livingroom.thermCorridor) annotation(Line(points={{21.696,13.84},{18,13.84},{18,-20},{36,-20},{36,-80},{-80,-80},{-80,43.3333},{-64.9412,43.3333}},
                                                                                                                                  color = {191, 0, 0}));
  connect(Livingroom.thermChildren, Children.thermLivingroom) annotation(Line(points={{-64.9412,38.1333},{-80,38.1333},{-80,90},{20,90},{20,48.64},{36,48.64}},
                                                                                                                      color = {191, 0, 0}));
  connect(Livingroom.thermCeiling, thermCeiling_Livingroom) annotation(Line(points={{-64.9412,32.9333},{-80,32.9333},{-80,38},{-110,38}},          color = {191, 0, 0}));
  connect(Livingroom.thermFloor, thermFloor_Livingroom) annotation(Line(points={{-64.9412,27.7333},{-80,27.7333},{-80,14},{-110,14}},          color = {191, 0, 0}));
  ...
  connect(Livingroom.ThermRoom, thermLivingroom) annotation(Line(points={{-42.3059,54.4267},{-42.3059,51.64},{-52,51.64},{-52,20}},          color = {191, 0, 0}));
  connect(Livingroom.StarInside1, StarLivingroom) annotation(Line(points={{-38.0235,54.4267},{-38.0235,54},{-32,54},{-32,20}},          color = {95, 95, 95}, pattern = LinePattern.Solid));
  ...
  connect(Livingroom.AirExchangePort, AirExchangePort[1]) annotation(Line(points={{-64.9412,65.8667},{-80,65.8667},{-80,90},{-9,90},{-9,127}},            color = {0, 0, 127}));
  ...
  connect(Livingroom.SolarRadiation_SE, SolarRadiation_SE) annotation(Line(points={{-52.0941,75.2267},{-52.0941,90},{28,90},{28,110}},          color = {255, 128, 0}));
