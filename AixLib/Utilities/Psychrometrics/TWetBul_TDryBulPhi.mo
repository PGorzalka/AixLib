...
equation
  if approximateWetBulb then
    ...
    (TWetBul-AixLib.Utilities.Psychrometrics.Constants.T_ref) * (
              ...
              (XiDryBul-XiSatRefIn) * AixLib.Utilities.Psychrometrics.Constants.cpWatLiq)
    =
    (TDryBul-AixLib.Utilities.Psychrometrics.Constants.T_ref) * (
              (1-XiDryBul) * AixLib.Utilities.Psychrometrics.Constants.cpAir +
              XiDryBul * AixLib.Utilities.Psychrometrics.Constants.cpSte)  +
    (XiDryBul-XiSatRefIn) * AixLib.Utilities.Psychrometrics.Constants.h_fg;
