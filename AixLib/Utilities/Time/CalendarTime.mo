...
model CalendarTime
  ...
  parameter Integer yearRef(min=firstYear, max=lastYear) = 2016
    ...
    annotation(Dialog(enable=zerTim==AixLib.Utilities.Time.Types.ZeroTime.Custom));
...
initial algorithm
  ...
  if zerTim == AixLib.Utilities.Time.Types.ZeroTime.UnixTimeStamp then
    timOff :=0;
  elseif zerTim == AixLib.Utilities.Time.Types.ZeroTime.UnixTimeStampGMT then
    timOff :=timZon;
  elseif zerTim == AixLib.Utilities.Time.Types.ZeroTime.NY2010 or
    zerTim == AixLib.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2010 then
      timOff :=timeStampsNewYear[1];
  elseif zerTim == AixLib.Utilities.Time.Types.ZeroTime.NY2011 or
    zerTim == AixLib.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2011 then
      timOff :=timeStampsNewYear[2];
  elseif zerTim == AixLib.Utilities.Time.Types.ZeroTime.NY2012 or
    zerTim == AixLib.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2012 then
      timOff :=timeStampsNewYear[3];
  elseif zerTim == AixLib.Utilities.Time.Types.ZeroTime.NY2013 or
    zerTim == AixLib.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2013 then
      timOff :=timeStampsNewYear[4];
  elseif zerTim == AixLib.Utilities.Time.Types.ZeroTime.NY2014 or
    zerTim == AixLib.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2014 then
      timOff :=timeStampsNewYear[5];
  elseif zerTim == AixLib.Utilities.Time.Types.ZeroTime.NY2015 or
    zerTim == AixLib.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2015 then
      timOff :=timeStampsNewYear[6];
  elseif zerTim == AixLib.Utilities.Time.Types.ZeroTime.NY2016 or
    zerTim == AixLib.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2016 then
      timOff :=timeStampsNewYear[7];
  elseif zerTim == AixLib.Utilities.Time.Types.ZeroTime.NY2017 or
    zerTim == AixLib.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2017 then
      timOff :=timeStampsNewYear[8];
  elseif zerTim == AixLib.Utilities.Time.Types.ZeroTime.NY2018 or
    zerTim == AixLib.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2018 then
      timOff :=timeStampsNewYear[9];
  elseif zerTim == AixLib.Utilities.Time.Types.ZeroTime.NY2019 or
    zerTim == AixLib.Utilities.Time.Types.ZeroTime.Custom and yearRef == 2019 then
  ...
  if zerTim == AixLib.Utilities.Time.Types.ZeroTime.Custom then
