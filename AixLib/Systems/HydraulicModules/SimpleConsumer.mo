...
model SimpleConsumer "Simple Consumer"
  ...
  parameter Modelica.Units.SI.Temperature T_fixed=293.15
    ...
    annotation (Dialog(enable=functionality == "T_fixed"));
  parameter Modelica.Units.SI.HeatCapacity capacity=1
    "Capacity of the material";
  parameter Modelica.Units.SI.Volume V=0.001 "Volume of water";
  parameter Modelica.Units.SI.HeatFlowRate Q_flow_fixed=0
    "Prescribed heat flow"
    annotation (Dialog(enable=functionality == "Q_flow_fixed"));
