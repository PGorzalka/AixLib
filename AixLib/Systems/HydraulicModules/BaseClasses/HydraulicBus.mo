...
expandable connector HydraulicBus "Data bus for hydraulic circuits"
  ...
  Modelica.Units.SI.Temperature TFwrdInMea "Flow Temperature into forward line";
  Modelica.Units.SI.Temperature TFwrdOutMea
    "Flow Temperature out of forward line";
  Modelica.Units.SI.Temperature TRtrnInMea "Temperature into return line";
  Modelica.Units.SI.Temperature TRtrnOutMea "Temperature out of return line";
  Modelica.Units.SI.VolumeFlowRate VFlowInMea "Volume flow into forward line";
  Modelica.Units.SI.VolumeFlowRate VFlowOutMea
    "Volume flow out of forward line";
  annotation (
