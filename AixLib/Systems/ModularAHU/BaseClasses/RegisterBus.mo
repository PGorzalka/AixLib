...
expandable connector RegisterBus "Data bus for modular ahu registers"
  ...
  Modelica.Units.SI.Temperature TAirInMea "Inlet air temperature";
  Modelica.Units.SI.Temperature TAirOutMea "Outlet air temperatur";
  Modelica.Units.SI.VolumeFlowRate VFlowAirMea "Air volume flow";
  annotation (
    Icon(graphics,
