...
block ReaderTMY3 "Reader for TMY3 weather data"
  ...
  Modelica.Blocks.Interfaces.RealInput pAtm_in(
    ...
    final unit="Pa",
    displayUnit="Pa") if (pAtmSou == AixLib.BoundaryConditions.Types.DataSource.Input)
    "Input pressure"
  ...
  Modelica.Blocks.Interfaces.RealInput TDryBul_in(
    ...
    final unit="K",
    displayUnit="degC") if (TDryBulSou == AixLib.BoundaryConditions.Types.DataSource.Input)
  ...
  Modelica.Blocks.Interfaces.RealInput TDewPoi_in(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    displayUnit="degC") if (TDewPoiSou == AixLib.BoundaryConditions.Types.DataSource.Input)
  ...
  //--------------------------------------------------------------
  // Relative humidity
  parameter AixLib.BoundaryConditions.Types.DataSource relHumSou=AixLib.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput relHum_in(
    min=0,
    max=1,
    unit="1") if (relHumSou == AixLib.BoundaryConditions.Types.DataSource.Input)
  ...
  Modelica.Blocks.Interfaces.RealInput winSpe_in(
    ...
    final unit="m/s",
    min=0) if (winSpeSou == AixLib.BoundaryConditions.Types.DataSource.Input)
    "Input wind speed"
  ...
  Modelica.Blocks.Interfaces.RealInput winDir_in(
    ...
    final unit="rad",
    displayUnit="deg") if (winDirSou == AixLib.BoundaryConditions.Types.DataSource.Input)
  ...
  Modelica.Blocks.Interfaces.RealInput HInfHor_in(
    ...
    final unit="W/m2") if (HInfHorSou == AixLib.BoundaryConditions.Types.DataSource.Input)
   ...
   parameter AixLib.BoundaryConditions.Types.RadiationDataSource HSou=AixLib.BoundaryConditions.Types.RadiationDataSource.File
...
//--------------------------------------------------------------
  // Ceiling height
  parameter AixLib.BoundaryConditions.Types.DataSource ceiHeiSou=AixLib.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput ceiHei_in(
    final quantity="Height",
    final unit="m",
    displayUnit="m") if (ceiHeiSou == AixLib.BoundaryConditions.Types.DataSource.Input)
    "Input ceiling height"
    annotation (Placement(transformation(extent={{-240,-10},{-200,30}}),
        iconTransformation(extent={{-240,-10},{-200,30}})));
  //--------------------------------------------------------------
  // Total sky cover
  parameter AixLib.BoundaryConditions.Types.DataSource totSkyCovSou=AixLib.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput totSkyCov_in(
    min=0,
    max=1,
    unit="1") if (totSkyCovSou == AixLib.BoundaryConditions.Types.DataSource.Input)
    "Input total sky cover"
    annotation (Placement(transformation(extent={{-240,-58},{-200,-18}}),
        iconTransformation(extent={{-240,-58},{-200,-18}})));
  // Opaque sky cover
  parameter AixLib.BoundaryConditions.Types.DataSource opaSkyCovSou=AixLib.BoundaryConditions.Types.DataSource.File
  ...
  Modelica.Blocks.Interfaces.RealInput opaSkyCov_in(
    min=0,
    max=1,
    unit="1") if (opaSkyCovSou == AixLib.BoundaryConditions.Types.DataSource.Input)
    "Input opaque sky cover"
    annotation (Placement(transformation(extent={{-240,32},{-200,72}}),
        iconTransformation(extent={{-240,32},{-200,72}})));

  parameter AixLib.BoundaryConditions.Types.SkyTemperatureCalculation
  ...
  final parameter Modelica.Units.SI.Angle lon(displayUnit="deg") =
    AixLib.BoundaryConditions.WeatherData.BaseClasses.getLongitudeTMY3(filNam)
    "Longitude";
  final parameter Modelica.Units.SI.Angle lat(displayUnit="deg") =
    AixLib.BoundaryConditions.WeatherData.BaseClasses.getLatitudeTMY3(filNam)
    "Latitude";
...
protected
  ...
  AixLib.BoundaryConditions.WeatherData.BaseClasses.LimiterRelativeHumidity limRelHum
    "Limiter for relative humidity"
    annotation (Placement(transformation(extent={{160,20},{180,40}})));
  AixLib.BoundaryConditions.WeatherData.BaseClasses.LimiterTotalSkyCover limTotSkyCov
    "Limits the total sky cover"
    annotation (Placement(transformation(extent={{160,-40},{180,-20}})));
  AixLib.BoundaryConditions.WeatherData.BaseClasses.LimiterOpaqueSkyCover limOpaSkyCov
    "Limits the opaque sky cover"
    annotation (Placement(transformation(extent={{160,-160},{180,-140}})));
  AixLib.BoundaryConditions.WeatherData.BaseClasses.LimiterCeilingHeight limCeiHei "Limits the ceiling height"
    annotation (Placement(transformation(extent={{160,-120},{180,-100}})));
  AixLib.BoundaryConditions.WeatherData.BaseClasses.LimiterWindSpeed limWinSpe "Limits the wind speed"
    annotation (Placement(transformation(extent={{160,-80},{180,-60}})));
  AixLib.BoundaryConditions.WeatherData.BaseClasses.LimiterHorizontalInfraredIrradiation limHorInfRad
  ...
  AixLib.BoundaryConditions.WeatherData.BaseClasses.ConvertTime conTimMin(final
  ...
  AixLib.Utilities.Psychrometrics.TWetBul_TDryBulPhi tWetBul_TDryBulXi(
  ...
  connect(chePre.pAtm, weaBus.pAtm) annotation (Line(points={{181,270},{220,270},
    ...
    Icon(coordinateSystem(
        ...
        Text(
          ...
          lineColor={0,0,255}),
        Text(
          visible=(pAtmSou == AixLib.BoundaryConditions.Types.DataSource.Input),
          extent={{-190,216},{-164,184}},
          lineColor={0,0,127},
          textString="p"),
        Text(
          visible=(TDryBulSou == AixLib.BoundaryConditions.Types.DataSource.Input),
          extent={{-194,162},{-118,118}},
          lineColor={0,0,127},
          textString="TDryBul"),
        Text(
          visible=(relHumSou == AixLib.BoundaryConditions.Types.DataSource.Input),
          extent={{-190,92},{-104,66}},
          lineColor={0,0,127},
          textString="relHum"),
        Text(
        visible=(winSpeSou == AixLib.BoundaryConditions.Types.DataSource.Input),
          extent={{-196,44},{-110,2}},
          lineColor={0,0,127},
          textString="winSpe"),
        Text(
          visible=(winDirSou == AixLib.BoundaryConditions.Types.DataSource.Input),
          extent={{-192,-18},{-106,-60}},
          lineColor={0,0,127},
          textString="winDir"),
        Text(
        visible=(HSou ==  AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor),
        extent={{-202,-88},{-112,-108}},
          lineColor={0,0,127},
          textString="HGloHor"),
        Text(visible=(HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor),
        extent={{-202,-142},{-116,-164}},
          lineColor={0,0,127},
          textString="HDifHor"),
        Text(
        visible=(HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor or HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor),
