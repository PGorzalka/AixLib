within AixLib.Obsolete.YearIndependent.FastHVAC.Components.HeatGenerators.CHP;
...
extends AixLib.Obsolete.BaseClasses.ObsoleteModel;
 ...
 /* *******************************************************************
    ...
    parameter FastHVAC.Data.CHP.BaseDataDefinition param=
      FastHVAC.Data.CHP.Ecopower()
    "Paramter contains data from CHP records" annotation (
    Dialog(enable=selectable),
...
public
 ...
 /* *******************************************************************
  ...
  FastHVAC.Components.Sensors.MassFlowSensor massFlowRate annotation (
      Placement(transformation(
        extent={{-11,-11},{11,11}},
        rotation=270,
        origin={-71,-11})));
  FastHVAC.Components.Sensors.TemperatureSensor T_flow annotation (
      Placement(transformation(
        extent={{-11,-13},{11,13}},
        rotation=0,
        origin={-61,-75})));
  FastHVAC.Components.Sensors.TemperatureSensor T_return annotation (
      Placement(transformation(
        extent={{-11,-13},{11,13}},
        rotation=0,
        origin={71,-75})));
