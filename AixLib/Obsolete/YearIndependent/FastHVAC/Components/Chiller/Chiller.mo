...
//General
  parameter
    ...
    Medium_con=AixLib.Obsolete.YearIndependent.FastHVAC.Media.WaterSimple()
    "Medium at sink side"
    annotation (Dialog(tab="Condenser"), choicesAllMatching=true);
  parameter
    AixLib.Obsolete.YearIndependent.FastHVAC.Media.BaseClasses.MediumSimple
    Medium_eva=AixLib.Obsolete.YearIndependent.FastHVAC.Media.WaterSimple()
...
//Advanced
  ...
  Interfaces.EnthalpyPort_b             enthalpyPort_b1(
    ...
    annotation (Placement(transformation(extent={{-96,-64},{-104,-56}})));
  AixLib.Obsolete.YearIndependent.FastHVAC.BaseClasses.EvaporatorCondenserWithCapacity
    con(
    ...
    final kAInn=GCon + GConIns*abs(mFlow_con.dotm/mFlow_conNominal_final)
        ^0.88,
  ...
  AixLib.Obsolete.YearIndependent.FastHVAC.BaseClasses.EvaporatorCondenserWithCapacity
    ...
    final kAInn=GEva + GEvaIns*abs(mFlow_eva.dotm/mFlow_evaNominal_final)
        ^0.88) "Heat exchanger model for the evaporator"
...
equation
  ...
  connect(mFlow_con.dotm, sigBus.m_flowConMea) annotation (Line(points={{-79,51},
          {-79,-42.915},{-104.925,-42.915}},color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,-6},{-3,-6}},
      horizontalAlignment=TextAlignment.Right));
  connect(nSet,sigBus.nSet)  annotation (Line(points={{-116,20},{-84,20},{-84,
  ...
  connect(modeSet, sigBus.modeSet) annotation (Line(points={{-116,-18},{-84,-18},
          {-84,-42.915},{-104.925,-42.915}},color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(senT_a1.T, sigBus.TConInMea) annotation (Line(points={{-33,81},{-33,
          -42.915},{-104.925,-42.915}},
                               color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,-6},{-3,-6}},
      horizontalAlignment=TextAlignment.Right));
  connect(senT_a2.T, sigBus.TEvaInMea) annotation (Line(points={{39,-75},{39,
          -36},{-30,-36},{-30,-42.915},{-104.925,-42.915}},
                                                       color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(senT_b1.T, sigBus.TConOutMea) annotation (Line(points={{39,81},{39,
          -36},{-30,-36},{-30,-42.915},{-104.925,-42.915}},
                                                       color={0,0,127}), Text(
      string="%second",
      index=1,
  ...
  connect(mFlow_eva.dotm, sigBus.m_flowEvaMea) annotation (Line(points={{69,-51},
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(senT_b2.T, sigBus.TEvaOutMea) annotation (Line(points={{-53,-75},{-53,
          -42.915},{-104.925,-42.915}},
                               color={0,0,127}), Text(
      string="%second",
      index=1,
