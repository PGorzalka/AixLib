...
///////////input parameters////////////
  ...
  parameter Modelica.Units.SI.Height hLowerPortDemand
    "Height of lower demand port";
  parameter Modelica.Units.SI.Height hUpperPortDemand
    "Height of upper demand port";
  parameter Modelica.Units.SI.Height hLowerPortSupply
    "Height of lower supply port";
  parameter Modelica.Units.SI.Height hUpperPortSupply
    "Height of upper supply port";
  ...
  parameter Modelica.Units.SI.SpecificHeatCapacity cIns
    "Heat capacity of insulation";
  parameter Modelica.Units.SI.Density rhoWall "Density of wall";
  parameter Modelica.Units.SI.SpecificHeatCapacity cWall
    "Heat capacity of wall";
  parameter Modelica.Units.SI.Length roughness
    "Inner roughness of storage wall";
