...
extends Modelica.Icons.Record;
  ...
  parameter Modelica.Units.SI.Volume vol[:] "Water volume of CHP";
  ...
  parameter Modelica.Units.SI.Temperature maxTFlow "Maximum flow temperature";
  parameter Modelica.Units.SI.Temperature maxTReturn
    "Maximum return temperature";
  parameter Modelica.Units.SI.Length DPipe "Outlet pipe diameter";
