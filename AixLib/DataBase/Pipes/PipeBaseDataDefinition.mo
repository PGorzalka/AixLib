...
record PipeBaseDataDefinition
  ...
  parameter Modelica.Units.SI.Diameter d_i "Inner pipe diameter";
  parameter Modelica.Units.SI.Diameter d_o "Outer pipe diameter";
  parameter Modelica.Units.SI.Density d "Density of pipe material";
